...
const FIRST_NAMES = ["James", "John", "Robert", "Michael", "William", "David", "Richard", "Joseph", "Thomas", "Charles", "Sarah", "Karen", "Nancy", "Lisa", "Betty", "Margaret", "Sandra", "Ashley", "Kimberly", "Emily", "Ahmed", "Mohamed", "Ali", "Wei", "Li", "Hiro", "Kenji", "Priya", "Rahul", "Maria", "Jose", "Carlos", "Ana", "Luis"];

const REVIEW_TEMPLATES = [
    "Saved me so much time for my {industry} business in {location}.",
    "Finally a free tool that actually works for {location} tax formats.",
    "Best {variation} generator I've found. Perfect for {industry} billing.",
    "I generate all my {industry} receipts here now. Love it!",
    "Simple, fast, and no watermarks. Exactly what I needed in {location}.",
    "My clients in {location} love the professional look of these invoices.",
    "Highly recommended for any {industry} working in {location}.",
    "Quickest way to make a {variation} without signing up.",
    "Does exactly what it says. Free PDF download for {industry}s.",
    "The generic templates didn't work for me, but this {industry} one is great."
];
...
export { COUNTRIES, INDUSTRIES, INTRO_TEMPLATES, BENEFITS, VARIATIONS, FIRST_NAMES, REVIEW_TEMPLATES };
