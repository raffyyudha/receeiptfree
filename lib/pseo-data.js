...
// EXPANDED KEYWORD VARIATIONS (High Intent)
const VARIATIONS = [
    // Core Types
    ...
    { prefix: 'standard-bill-for', label: 'Standard Bill', type: 'Bill' },
...
export { COUNTRIES, INDUSTRIES, INTRO_TEMPLATES, VARIATIONS };
